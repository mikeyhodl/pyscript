...
This is 2.0.1, released on May 2, 2026.  Here is the `documentation
<https://hacs-pyscript.readthedocs.io/en/2.0.1>`__ for that release.  Here is the
...
If you want to see development progress since 2.0.1, look at the
